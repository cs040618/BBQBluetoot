...
public class PanelViewAttr {
    ...
    public PanelViewAttr(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimensionPixelSize(PxUtils.spToPx(R.styleable.PanelView_android_textSize, context), 35);
        mText = ta.getString(R.styleable.PanelView_android_text);
        arcwidth = ta.getInt(R.styleable.PanelView_arcWidth, 3);
        mScendArcWidth = ta.getInt(R.styleable.PanelView_secArcWidth, 130); //100
        ...
        position = ta.getInt(R.styleable.PanelView_position, 0);
        ta.recycle();
    }
